    ...
    def __getitem__(self, idx):
        ...
        for i in batch_indices:
            ...
            if mask_path and mask_path != "":
                ...
                mask = np.zeros_like(image) if image is not None else np.zeros((256, 256), dtype=np.uint8)
...
def prepare_dataset(dataset_path="./dataset", test_size=0.15, val_size=0.15):
